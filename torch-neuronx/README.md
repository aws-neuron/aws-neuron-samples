...
| [HuggingFace Stable Diffusion 2.1 (512x512)](inference/hf_pretrained_sd2_512_inference.ipynb)         | Image classification                                                                       | [stable-diffusion](https://huggingface.co/stabilityai/stable-diffusion-2) |
| [HuggingFace Stable Diffusion 2.1 (768x768)](inference/hf_pretrained_sd2_768_inference.ipynb)         | Image classification                                                                       | [stable-diffusion](https://huggingface.co/stabilityai/stable-diffusion-2) |
| [UNet](inference/pretrained_unet_inference_on_trn1.ipynb)         | Image classification                                                                          | [unet](https://github.com/milesial/Pytorch-UNet) |
| [Torchvision ResNet](inference/tv_pretrained_vgg_inference_on_trn1.ipynb)         | Image classification                                                                          | [vgg](https://pytorch.org/vision/main/models/generated/torchvision.models.vgg11.html) |
...
| [gptj](transformers-neuronx/inference/gpt-j-6b-sampling.ipynb) | Inf2 & Trn1 |